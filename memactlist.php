...
$msg = "";
$msg.='<thead><tr><th>會員姓名</th><th>性別</th><th>手機</th><th>購買次數</th><th>活躍率</th></tr></thead><tbody>';
foreach ($stmt->fetchAll(PDO::FETCH_ASSOC) as $row) {
    $msg.="<tr><td>" . $row['name'] . "</td><td>" . $row['gender'] . "</td><td>" . $row['cellphone'] . "</td><td>" . $row['buycount'] . "</td><td>" . $row['percent'] . "</td></tr>";
    $count = $count + 1;
}
$msg.="</tbody>";
echo  $msg;
